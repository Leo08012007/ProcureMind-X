...
export const metadata: Metadata = {
  title: 'ProcureMind X - Autonomous Procurement OS',
  description: 'The World\'s First Autonomous Procurement Operating System powered by multi-agent swarms.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="antialiased min-h-screen bg-slate-950 text-slate-100 selection:bg-indigo-500/30">
